...
Q.1.9. Place of birth [pos => i $$ dynamicLoader => loadPlaceOfBirth(__$('inputField').value.trim()) $$ tt_onLoad => loadPlaceOfBirth('') $$ tt_showToggleKeyboard => false $$ showKeys => false]

Q.1.10. Current Region [pos => j $$ dynamicLoader => loadRegion(__$('inputField').value.trim()) $$ tt_onLoad => loadRegion('') $$ tt_showToggleKeyboard => true $$ showKeys => false]

Q.1.11. Current District [pos => k $$ dynamicLoader => loadDistrict(__$('inputField').value.trim(),__$("1.10").value.trim().toLowerCase()) $$ tt_onLoad => loadDistrict('',__$("1.10").value.trim().toLowerCase()) $$ tt_showToggleKeyboard => false $$ showKeys => false]

Q.1.12. Current Traditional Authority [pos => l $$ dynamicLoader => loadTA(__$('inputField').value.trim(),__$("1.11").value.trim().toLowerCase()) $$ tt_onLoad => loadTA('',__$("1.11").value.trim().toLowerCase()) $$ tt_showToggleKeyboard => true $$ showKeys => true]

Q.1.13. Current Village [pos => m $$ dynamicLoader => loadVillage(__$('inputField').value.trim(),__$("1.12").value.trim().toLowerCase()) $$ tt_onLoad => loadVillage('',__$("1.12").value.trim().toLowerCase()) $$ tt_showToggleKeyboard => true $$ showKeys => false]

Q.1.14. Remarks [pos => n $$ tt_showToggleKeyboard => true $$ optional => true]

Q.1.15. Do you want to add relationships now? [pos => o $$ dynamicLoader => listValues(__$('inputField').value.trim(), {"Yes":"Yes", "No":"No"}) $$ tt_onLoad => listValues('', {"Yes":"Yes", "No":"No"}) $$ tt_showToggleKeyboard => false $$ showKeys => false]

Q.1.16. Relation First Name [pos => p $$ dynamicLoader => listFirstNames(__$('inputField').value.trim()) $$ tt_onLoad => listFirstNames('') $$ tt_showToggleKeyboard => true $$ showKeys => true $$ condition => __$("1.15").value == "Yes"]

Q.1.17. Relation Last Name [pos => q $$ dynamicLoader => listLastNames(__$('inputField').value.trim()) $$ tt_onLoad => listLastNames('') $$ tt_showToggleKeyboard => true $$ showKeys => true $$ condition => __$("1.15").value == "Yes"]
