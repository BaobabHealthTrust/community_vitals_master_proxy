...
Q.1.2. Select Month [pos => 1 $$ tt_showToggleKeyboard => true $$ dynamicLoader => loadMonths(__$('inputField').value.trim()) $$ tt_onLoad => loadMonths('') $$ condition => __$("1.1").value.trim().toLowerCase() != "unknown"]
