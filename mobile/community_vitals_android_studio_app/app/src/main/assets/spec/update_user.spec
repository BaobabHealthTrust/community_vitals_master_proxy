...
Q.1.7. User Roles [pos => 7 $$ tt_showToggleKeyboard => true $$ showKeys => false $$ dynamicLoader => listFilteredUserRoles(__$('inputField').value.trim()) $$ condition => (Android.getPref("param") ? (String(Android.getPref("f")).match(/role/i) ? true : false) : true) $$ tt_onLoad => listFilteredUserRoles('')]
