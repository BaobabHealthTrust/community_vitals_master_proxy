...
Q.1.1. Select Report Type [pos => 0 $$ tt_showToggleKeyboard => false $$ showKeys => false $$ dynamicLoader => loadCohortType(__$('inputField').value.trim()) $$ tt_onLoad => loadCohortType('')]
